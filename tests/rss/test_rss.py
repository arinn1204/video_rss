...
def test_should_parse_feed_from_config(mocker):
    ...
    feedparser.assert_called_once_with('showrss.info/test_should_parse_feed_from_config')  # noqa: E501
...
def test_should_retrieve_all_rss_objects(mocker):
    ...
    assert data[0] == {
        ...
        'magnet': 'magnet:?xt=urn:btih:743E0F4656DFD378420C6C8B9127121B1D656E3A&dn=Vikings+S06E07+720p+WEB+H264+GHOSTS&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.opentrackr.org%3A1337%2Fannounce&tr=http%3A%2F%2Ftracker.trackerfix.com%3A80%2Fannounce',  # noqa: E501
