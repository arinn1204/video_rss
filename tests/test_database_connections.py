...
class TestDatabaseConnection:
    ...
    def test_constructing_proper_connection_string_for_sql_server_with_sspi(self, mocker):  # noqa: E501
    ...
    def test_constructing_proper_connection_string_for_sql_server_without_sspi(self, mocker):  # noqa: E501
        connect_mocker = mocker.Mock()
        mocker.patch('pyodbc.connect', new=connect_mocker)
